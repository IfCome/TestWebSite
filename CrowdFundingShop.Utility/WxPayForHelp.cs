...
namespace CrowdFundingShop.Utility
{
    public class WxPayForHelp
    {
        ...
        /// <returns></returns>
//        public string DoDataForPayWeiXin(WxPayModel payForWeiXin)
//        {
//            #region 处理nonce_str随机字符串，不长于 32 位
//            string str = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
//            payForWeiXin.nonce_str = RandomStr(str, 32);
//            payForWeiXin.act_id = RandomStr(str, 16);
//            #endregion
//            //商户支付密钥key
//            string key = payForWeiXin.key;
...
//        }
        ...
        /// 生成随机数
        /// </summary>
        /// <param name="str">将要随机的字符串</param>
        /// <param name="Length">位数限制</param>
        /// <returns></returns>
